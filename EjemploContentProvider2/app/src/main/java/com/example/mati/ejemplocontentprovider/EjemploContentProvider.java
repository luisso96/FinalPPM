    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnConsultar.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String uri = "content://com.example.mati.ejemplocontentprovider.EjemploContentProvaider/usuarios";
                Uri usuariosUri =  Uri.parse(uri);
                Log.e("ContentProvider", "LLEGAMOS");
        ...
        btnInsertar.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                //Incorporamos el uri al que queremos acceder
                String uri = "content://com.example.mati/usuarios";
                Uri usuariosUri =  Uri.parse(uri);
                //Obtenemos una referencia al content provider al que queremos acceder
                ContentResolver cr = getContentResolver();
        ...
        btnEliminar.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                //Incorporamos el uri al que queremos acceder
                String uri = "content://com.example.mati.EjemploContentProvider/usuarios";
                Uri usuariosUri =  Uri.parse(uri);
                //Obtenemos una referencia al content provider al que queremos acceder
                ContentResolver cr = getContentResolver();
